        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Marathons_Themes_ThemeId",
                        column: x => x.ThemeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhenClaimed = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users_Badges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_Badges_Badges_BadgeId",
                        column: x => x.BadgeId,
                        principalTable: "Badges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_Badges_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_Marathons_MarathonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Progresses_Marathons_MarathonId",
                        column: x => x.MarathonId,
                        principalTable: "Marathons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_MarathonId",
                table: "Exercises",
                column: "MarathonId");

            migrationBuilder.CreateIndex(
                name: "IX_Marathons_ThemeId",
                table: "Marathons",
                column: "ThemeId");

            migrationBuilder.CreateIndex(
                name: "IX_Progresses_MarathonId",
                table: "Progresses",
                column: "MarathonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Badges_BadgeId",
                table: "Users_Badges",
                column: "BadgeId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_Badges_UserId",
                table: "Users_Badges",
                column: "UserId");
        }
